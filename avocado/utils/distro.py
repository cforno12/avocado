...
class Probe:
    ...
    If given an avocado.utils.network.hosts.Host object a machine either LocalHost or RemoteHost,
    Probe will attempt to detect another machine's distro via an ssh connection.
    """
